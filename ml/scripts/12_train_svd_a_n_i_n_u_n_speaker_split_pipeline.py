...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Train an SVD pathology pipeline using a_n, i_n and u_n with "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "<subject_id>/vowels/*-a_n.wav, *-i_n.wav and *-u_n.wav."
        ),
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("ml/models/svd_a_n_i_n_u_n_speaker_split"),
...
def split_subjects_three_way(
    ...
    train_subjects, holdout_subjects, _, holdout_labels = train_test_split(
        unique_subjects,
        unique_labels,
